...
public class AlgeManipulatorVisualizer {
  ...
  public AlgeManipulatorVisualizer(String key, Color color) {
    ...
    arm =
        new LoggedMechanismLigament2d(
            "arm", AlgeManipulatorConstants.armLength, 20.0, 6, new Color8Bit(color));
