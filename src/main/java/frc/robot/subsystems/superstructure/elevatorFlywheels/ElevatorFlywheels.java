 ...
 */
public class ElevatorFlywheels extends SubsystemBase {
  // IO interface for controlling and reading from the flywheel hardware
  private final ElevatorFlywheelsIO io;
  // Structure holding inputs from the FlywheelIO, automatically logged for telemetry
  private final ElevatorFlywheelsIOInputsAutoLogged inputs =
      new ElevatorFlywheelsIOInputsAutoLogged();
   ...
   */
  public ElevatorFlywheels(ElevatorFlywheelsIO io) {
    this.io = io;
