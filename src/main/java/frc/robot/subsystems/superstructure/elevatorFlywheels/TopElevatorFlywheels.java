 ...
 */
public class TopElevatorFlywheels extends SubsystemBase {
  // IO interface for controlling and reading from the flywheel hardware
  private final TopElevatorFlywheelsIO io;
  // Structure holding inputs from the FlywheelIO, automatically logged for telemetry
  private final TopElevatorFlywheelsIOInputsAutoLogged inputs =
      new TopElevatorFlywheelsIOInputsAutoLogged();
   ...
   */
  public TopElevatorFlywheels(TopElevatorFlywheelsIO io) {
    this.io = io;
  ...
  public void runVelocity(double velocityRPM) {
    ...
    Logger.recordOutput("Elevator Flywheel/SetpointRPM", velocityRPM);
  }
