 ...
 */
public class ElevatorFlywheelsIOSparkMax implements ElevatorFlywheelsIO {
  ...
  private final SparkMax leader = new SparkMax(34, MotorType.kBrushless);
   ...
   * controllers.
   */
  public ElevatorFlywheelsIOSparkMax() {
   ...
   */
  @Override
  public void updateInputs(ElevatorFlywheelsIOInputs inputs) {
