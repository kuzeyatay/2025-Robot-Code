 ...
 */
public class AlgeManipulatorFlywheelsSparkMax implements AlgeManipulatorFlywheelsIO {
  // Defines the gear ratio for the flywheel mechanism (if any)
  private static final double GEAR_RATIO = 42 / 18;

  // Creates a SPARK MAX controller for the leader motor, using a Brushless NEO
  private final SparkMax leader = new SparkMax(18, MotorType.kBrushless);
   ...
   * controllers.
   */
  public AlgeManipulatorFlywheelsSparkMax() {
   ...
   */
  @Override
  public void updateInputs(AlgeManipulatorFlywheelsIOInputs inputs) {
