 ...
 */
public interface AlgeManipulatorFlywheelsIO {
  // AutoLog annotation indicates that the FlywheelIOInputs class fields will be automatically
  // logged
  @AutoLog
  public static class AlgeManipulatorFlywheelsIOInputs {
   ...
   */
  public default void updateInputs(AlgeManipulatorFlywheelsIOInputs inputs) {}
