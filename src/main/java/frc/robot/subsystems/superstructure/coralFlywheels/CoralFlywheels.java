 ...
 */
public class CoralFlywheels extends SubsystemBase {
  // IO interface for controlling and reading from the flywheel hardware
  private final CoralFlywheelsIO io;
  // Structure holding inputs from the FlywheelIO, automatically logged for telemetry
  private final CoralFlywheelsIOInputsAutoLogged inputs = new CoralFlywheelsIOInputsAutoLogged();
   ...
   */
  public CoralFlywheels(CoralFlywheelsIO io) {
    this.io = io;
