...
public class CoralWristVisualizer {
  ...
  public CoralWristVisualizer(String key, Color color) {
    ...
    LoggedMechanismRoot2d root = mechanism.getRoot("Coral Wrist Pivot", 1.0, 0.4);
    ...
    arm =
        new LoggedMechanismLigament2d(
            "Coral Wrist", CoralWristConstants.armLength, 20.0, 6, new Color8Bit(color));
  ...
  public void update(double angleRads) {
    ...
    Logger.recordOutput("Coral Wrist/Mechanism2d/" + key, mechanism); // FIXME
  }
}
