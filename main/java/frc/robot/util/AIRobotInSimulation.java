 ...
 *
 * <p>This class models an AI-controlled robot used during simulation for driver practice and skill
 * development.
 *
 * <p>The AI robots are capable of performing various tasks to enhance training scenarios,
 * including:
 *
 * <ul>
...
public class AIRobotInSimulation extends SubsystemBase {
   ...
   *
   * <p>The opponent robots <strong>will not</strong> appear on the field immediately. They are
   * initially placed at the {@link #ROBOT_QUEENING_POSITIONS}.
   *
   * <p>Instead of being active right away, a sendable chooser is sent to the dashboard, allowing
   * the user to select the mode of these robots.
   */
  ...
  /**
   * Builds the behavior chooser for this opponent robot and sends it to the dashboard. This allows
   * the user to select the robot's behavior mode during simulation.
   */
  ...
  private Command opponentRobotFollowPath(PathPlannerPath path) {
    return new FollowPathCommand(
        ...
        // Provide PathPlanner with the actual robot speed in the simulation, ignoring encoder
        // measurement error
